...
import PerPaper from "@/views/Paper/ShowPaper/Sections/PerPaper.vue";
...
function get_paper() {
  ...
  if(count <= 0) {
    ...
    equal_or_contain.value = proxy.$store.state.isEqual
  ...
  <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center mx-auto my-auto" style="--el-border-radius-base:20px">
          <h1 class="text-white">
            <el-input
                v-model="input_info"
...
<!--          <span style="display: inline; color:black">共2516条数据</span>-->
        </div>
      </div>
    </div>
    <PerPaper
